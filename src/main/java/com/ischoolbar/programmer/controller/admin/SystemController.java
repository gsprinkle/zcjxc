...
public class SystemController {
	...
	public Map<String, String> loginAct(User user, HttpServletRequest request) {
		// public Map<String, String> loginAct(User user,String
		// cpacha,HttpServletRequest request){
		...
		// 验证码；
		/*
		 * if(StringUtils.isEmpty(cpacha)){ ret.put("type", "error");
		 * ret.put("msg", "请填写验证码！"); return ret; }
		 */
	...
	public void generateCpacha(@RequestParam(name = "vl", required = false, defaultValue = "4") Integer vcodeLen,
			@RequestParam(name = "w", required = false, defaultValue = "100") Integer width, @RequestParam(name = "h", required = false, defaultValue = "30") Integer height,
			@RequestParam(name = "type", required = true, defaultValue = "loginCpacha") String cpachaType, HttpServletRequest request, HttpServletResponse response) {
